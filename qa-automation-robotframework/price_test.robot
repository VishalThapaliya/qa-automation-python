...
Cart Total Should Match Sum Of Item Prices
    ...
    Click Element Via JS                    [data-test="add-to-cart-sauce-labs-bike-light"]
...
Cart Total Should Match Sum Of Three Item Prices
    ...
    Click Element Via JS                    [data-test="add-to-cart-sauce-labs-bolt-t-shirt"]
    Wait Until Element Is Visible           css=.shopping_cart_link
    Click Element Via JS                    .shopping_cart_link
    Wait Until Element Is Visible           css=.checkout_button
